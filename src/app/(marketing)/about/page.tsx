...
export default function AboutPage() {
  return (
    <>
      ...
      >
        {/* Ambient circles — top-right, behind text */}
        <div aria-hidden="true" className="about-hero-circle about-hero-circle-1" />
        <div aria-hidden="true" className="about-hero-circle about-hero-circle-2" />
        <div aria-hidden="true" className="about-hero-circle about-hero-circle-3" />
